...
public class ContextAndListenerTests {
	...
	public void testExamineJobContextInArtifact() throws Exception {
		...
		try {
			...
			assertWithMessage(execution1, "Testing batch status", BatchStatus.COMPLETED, execution1.getBatchStatus());
			assertWithMessage(execution1, "Testing exit status", testString, execution1.getExitStatus());
		} catch (Exception e) {
			handleException(METHOD, e);
		}
	}
	...
	public void testExamineStepContextInArtifact() throws Exception {
		...
		try {
			...
			assertWithMessage(execution1, "list of step executions == 1", steps.size() == 1);
	...
	public void testOneArtifactIsJobAndStepListener() throws Exception {
		...
		try {
			...
			Reporter.log("ACTUAL JobExecution getExitStatus()="+execution1.getExitStatus()+"<p>");
			assertWithMessage(execution1, "Testing batch status", BatchStatus.COMPLETED, execution1.getBatchStatus());
			assertWithMessage(execution1, "Testing exit status", expectedStr, execution1.getExitStatus());
		} catch (Exception e) {
			handleException(METHOD, e);
		}
	}
	...
	public void testgetException() throws Exception {
		...
		try {
			...
			Reporter.log("EXPECTED JobExecution getExitStatus()="+expectedStr+"<p>");
			Reporter.log("ACTUAL JobExecution getExitStatus()="+execution1.getExitStatus()+"<p>");
			assertWithMessage(execution1, "Testing batch status", BatchStatus.FAILED, execution1.getBatchStatus());
			assertWithMessage(execution1, "Testing exit status", expectedStr, execution1.getExitStatus());
		} catch (Exception e) {
			handleException(METHOD, e);
		}
    ...
    public void testJobContextIsUniqueForMainThreadAndPartitions() throws Exception {
        ...
        try {
            ...
            assertWithMessage(jobExecution, "COMPLETED", jobExecution.getExitStatus());
    ...
    public void testStepContextIsUniqueForMainThreadAndPartitions() throws Exception {
        ...
        try {
            ...
            assertWithMessage(jobExecution, "COMPLETED", stepExec.getExitStatus());
