...
public class ChunkTests {
    ...
    public void testChunkNoProcessorDefined() throws Exception {
        ...
        try {
            ...
            assertWithMessage(execution1, "Testing execution #1", "buffer size = 10", execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    ...
    public void testChunkNullCheckpointInfo() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", "checkpointInfo is null in reader.open...checkpointInfo is null in writer.open", execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
   ...
   public void testChunkArtifactInstanceUniqueness() throws Exception {
       ...
       try {
           ...
           Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
           assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
           assertWithMessage(execution1, "Testing execution #1", "nullChunkListenerChunkListenerStepListenerStepListenerJobListenerJobListener", execution1.getExitStatus());
       } catch (Exception e) {
           handleException(METHOD, e);
       }
    ...
    public void testChunkOnErrorListener() throws Exception {
    	...
    	try {
            ...
            assertWithMessage(execution1, "Testing execution #1", "Chunk onError invoked", execution1.getExitStatus());
    ...
    public void testChunkTimeBasedDefaultCheckpoint() throws Exception {
        ...
        try {
	        ...
	        assertWithMessage(execution1, "Testing execution #1", (exitStatus.equals("TRUE: 0") || exitStatus.equals("TRUE: 1")));
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    }
    ...
    public void testChunkTimeBased10Seconds() throws Exception {
    	...
    	try {
	        ...
	        assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
	        String exitStatus = execution1.getExitStatus();
	        assertWithMessage(execution1, "Testing execution #1", (exitStatus.equals("TRUE: 9") || exitStatus.equals("TRUE: 10") || exitStatus.equals("TRUE: 11")));
    ...
    public void testChunkRestartTimeBasedCheckpoint() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.FAILED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", "FALSE: 0", execution1.getExitStatus());
...

            {
    	        ...
    	        assertWithMessage(exec, "Testing execution #2", (exitStatus.equals("TRUE: 9") || exitStatus.equals("TRUE: 10") || exitStatus.equals("TRUE: 11")));
    ...
    public void testChunkRestartTimeBasedDefaultCheckpoint() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.FAILED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", "TRUE: 0", execution1.getExitStatus());
            ...
            Reporter.log("Got Job execution id: " + lastExecutionId + "<p>");
            {
                ...
                Reporter.log("execution #2 Job instance id=" + exec.getInstanceId() + "<p>");
                assertWithMessage(exec, "Testing execution #2", BatchStatus.COMPLETED, exec.getBatchStatus());
                assertWithMessage(exec, "Testing execution #2", "TRUE: 0", exec.getExitStatus());
                assertWithMessage(exec, "Testing execution #2", jobInstanceId, exec.getInstanceId());
            }
        } catch (Exception e) {
            handleException(METHOD, e);
    ...
    public void testChunkSkipMultipleExceptions() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.FAILED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", MySkipReadListener.GOOD_EXIT_STATUS, execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    ...
    public void testChunkSkipProcess() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", MySkipProcessListener.GOOD_EXIT_STATUS, execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    }
    ...
    public void testChunkSkipWrite() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", MySkipWriteListener.GOOD_EXIT_STATUS, execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    ...
    public void testChunkSkipOnError() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.COMPLETED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", "MyItemReadListenerImpl.onReadError", execution1.getExitStatus());
            ...
            assertWithMessage(execution2, "Testing execution #1", BatchStatus.COMPLETED, execution2.getBatchStatus());
            assertWithMessage(execution2, "Testing execution #1", "MyItemProcessListenerImpl.onProcessError", execution2.getExitStatus());
            ...
            assertWithMessage(execution3, "Testing execution #1", BatchStatus.COMPLETED, execution3.getBatchStatus());
            assertWithMessage(execution3, "Testing execution #1", "MyItemWriteListenerImpl.onWriteError", execution3.getExitStatus());
    ...
    public void testChunkRetryMultipleExceptions() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1", BatchStatus.FAILED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1", MyMultipleExceptionsRetryReadListener.GOOD_EXIT_STATUS, execution1.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    ...
    public void testChunkItemListeners() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getBatchStatus()=" + execution1.getBatchStatus() + "<p>");
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1 for the READ LISTENER", BatchStatus.COMPLETED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1 for the READ LISTENER", MyItemReadListenerImpl.GOOD_EXIT_STATUS,
            ...
            assertWithMessage(execution2, "Testing execution #2 for the PROCESS LISTENER", BatchStatus.COMPLETED, execution2.getBatchStatus());
            assertWithMessage(execution2, "Testing execution #2 for the PROCESS LISTENER", MyItemProcessListenerImpl.GOOD_EXIT_STATUS,
            ...
            assertWithMessage(execution3, "Testing execution #3 for the WRITE LISTENER", BatchStatus.COMPLETED, execution3.getBatchStatus());
            assertWithMessage(execution3, "Testing execution #3 for the WRITE LISTENER", MyItemWriteListenerImpl.GOOD_EXIT_STATUS,
    ...
    public void testChunkItemListenersOnError() throws Exception {
        ...
        try {
            ...
            Reporter.log("execution #1 JobExecution getBatchStatus()=" + execution1.getBatchStatus() + "<p>");
            Reporter.log("execution #1 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution1, "Testing execution #1 for the READ LISTENER", BatchStatus.FAILED, execution1.getBatchStatus());
            assertWithMessage(execution1, "Testing execution #1 for the READ LISTENER", "MyItemReadListenerImpl.onReadError",
                    execution1.getExitStatus());
            ...
            Reporter.log("execution #2 JobExecution getBatchStatus()=" + execution1.getBatchStatus() + "<p>");
            Reporter.log("execution #2 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution2, "Testing execution #2 for the PROCESS LISTENER", BatchStatus.FAILED, execution2.getBatchStatus());
            assertWithMessage(execution2, "Testing execution #2 for the PROCESS LISTENER", "MyItemProcessListenerImpl.onProcessError",
                    execution2.getExitStatus());
            ...
            Reporter.log("execution #3 JobExecution getBatchStatus()=" + execution1.getBatchStatus() + "<p>");
            Reporter.log("execution #3 JobExecution getExitStatus()=" + execution1.getExitStatus() + "<p>");
            assertWithMessage(execution3, "Testing execution #3 for the WRITE LISTENER", BatchStatus.FAILED, execution3.getBatchStatus());
            assertWithMessage(execution3, "Testing execution #3 for the WRITE LISTENER", "MyItemWriteListenerImpl.onWriteError",
                    execution3.getExitStatus());
        } catch (Exception e) {
            handleException(METHOD, e);
        }
    ...
    public void testUserDataIsPersistedAfterCheckpoint() throws Exception {
        ...
        try {
            ...
            assertWithMessage(execution1, "Testing execution #1", 1, persistedStepData.getExecutionNumber());
